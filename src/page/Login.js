  ...
  return (
    ...
    <div className="w-full max-w-md  m-auto flex justify-center flex-col items-center p-4  bg-green-700 rounded-md mt-5">
      ...
      <form className="w-full flex flex-col gap-4 py-3" action="" onSubmit={handleSubmit}>
        ...
        <button className=" w-full max-w-[150px] m-auto text-xl text-white font-bold mt-4 p-1 bg-yellow-500 hover:bg-yellow-600 rounded-md">Connexion</button>
      </form>
      <p className="text-white mt-2 font-semibold">Pas encore inscrit·e ? <Link className="text-yellow-500 underline" to={"/signup"}>Inscription</Link></p>
    </div>
  </div>
  )
}
